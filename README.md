...
本仓库按 AI 产品经理作品集方式整理，重点展示从真实 B 端痛点到 AI 工作流、可互动 demo、评估指标、安全边界和商业化 PoC 的完整思考。

## 作品集入口

| 材料 | 用途 |
| --- | --- |
| [阿里 AI PM 提交版作品集](docs/portfolio/alibaba_ai_pm_submission.md) | 面试官 5-10 分钟快速理解项目价值、岗位匹配和产品判断 |
...
| 商业化试点 | 汽车零部件加工 PoC 数据包、验收指标、ROI 测算、4-6 周落地路径 |
