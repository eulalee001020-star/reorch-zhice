...
| 关键能力 | 作品集证据 |
| --- | --- |
| 行业调研 | [市场需求与行业先进标准对标](docs/portfolio/market_benchmark.md)、[金蝶对标下的定位说明](docs/portfolio/kingdee_positioning_note.md)、[服务领域 AI 迁移说明](docs/portfolio/service_ai_transfer_note.md) |
