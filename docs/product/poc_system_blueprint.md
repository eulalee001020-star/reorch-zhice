...
现有代码已经具备异常接入、受控 Agent 工作流、影响分析、策略选择、求解、评价、解释、确认、反馈归因沉淀、案例库、初始调度、方案质量闸门、ROI 估算、数字孪生样例、adapter contract、Mock/CSV/REST 客户适配器、mock ERP/MES/APS server、PostgreSQL 优先持久化、登录/RBAC、后台任务、Docker Compose smoke CI。
