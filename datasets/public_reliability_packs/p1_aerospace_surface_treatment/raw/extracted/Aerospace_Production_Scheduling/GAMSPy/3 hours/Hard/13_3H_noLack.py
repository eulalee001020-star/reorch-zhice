"""
GAMSPy — gerado automaticamente de: 13_3H_noLack.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 13_3H_noLack.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "13_3H_noLack.csv")
