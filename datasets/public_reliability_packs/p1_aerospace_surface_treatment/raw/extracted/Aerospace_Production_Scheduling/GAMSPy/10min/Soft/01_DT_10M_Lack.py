"""
GAMSPy — gerado automaticamente de: 01_DT_10M_Lack.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 01_DT_10M_Lack.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "01_DT_10M_Lack.csv")
