"""
GAMSPy — gerado automaticamente de: 11_DT_10M_Lack.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 11_DT_10M_Lack.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "11_DT_10M_Lack.csv")
