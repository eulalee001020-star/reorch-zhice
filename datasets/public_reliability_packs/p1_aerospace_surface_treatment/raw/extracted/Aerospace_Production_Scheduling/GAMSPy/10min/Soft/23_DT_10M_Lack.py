"""
GAMSPy — gerado automaticamente de: 23_DT_10M_Lack.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 23_DT_10M_Lack.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "23_DT_10M_Lack.csv")
