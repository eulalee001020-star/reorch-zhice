"""
GAMSPy — gerado automaticamente de: 13_Double_T_10M.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 13_Double_T_10M.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "13_Double_T_10M.csv")
