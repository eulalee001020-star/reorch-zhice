"""
GAMSPy — gerado automaticamente de: 27_DT_10M_Lack.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 27_DT_10M_Lack.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "27_DT_10M_Lack.csv")
