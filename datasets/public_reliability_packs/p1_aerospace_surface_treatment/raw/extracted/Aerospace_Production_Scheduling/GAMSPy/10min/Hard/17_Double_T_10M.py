"""
GAMSPy — gerado automaticamente de: 17_Double_T_10M.gms
...
# ── Opções ────────────────────────────────────────────────────────
m = Container()
options = Options(time_limit=600, relative_optimality_gap=0.0)
...
# Família 1H: sem variável de folga L
# ── Equações ──────────────────────────────────────────────────────
obj_expr = Sum((T, K), U[T, K])

RESTRI_1 = Equation(m, "RESTRI_1", domain=[I])
RESTRI_1[I] = Sum((T, K, F), X[T, K, F, I]) == IE[I]
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 17_Double_T_10M.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "17_Double_T_10M.csv")
