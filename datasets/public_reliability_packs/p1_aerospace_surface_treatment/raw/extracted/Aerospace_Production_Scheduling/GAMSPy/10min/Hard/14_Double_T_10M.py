"""
GAMSPy — gerado automaticamente de: 14_Double_T_10M.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 14_Double_T_10M.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "14_Double_T_10M.csv")
