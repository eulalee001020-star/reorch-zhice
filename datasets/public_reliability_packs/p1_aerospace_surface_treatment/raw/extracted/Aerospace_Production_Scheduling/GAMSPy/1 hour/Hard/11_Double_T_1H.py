"""
GAMSPy — gerado automaticamente de: 11_Double_T_1H.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 11_Double_T_1H.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "11_Double_T_1H.csv")
