"""
GAMSPy — gerado automaticamente de: 04_DT_1H_Lack.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 04_DT_1H_Lack.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "04_DT_1H_Lack.csv")
