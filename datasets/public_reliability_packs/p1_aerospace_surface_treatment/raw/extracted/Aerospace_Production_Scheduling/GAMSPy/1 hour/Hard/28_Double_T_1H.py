"""
GAMSPy — gerado automaticamente de: 28_Double_T_1H.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 28_Double_T_1H.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "28_Double_T_1H.csv")
