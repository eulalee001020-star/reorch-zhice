"""
GAMSPy — gerado automaticamente de: 23_Double_T_1H.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 23_Double_T_1H.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "23_Double_T_1H.csv")
