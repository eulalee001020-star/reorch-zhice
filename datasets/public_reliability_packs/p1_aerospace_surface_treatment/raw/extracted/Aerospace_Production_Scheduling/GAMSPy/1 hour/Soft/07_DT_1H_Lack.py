"""
GAMSPy — gerado automaticamente de: 07_DT_1H_Lack.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 07_DT_1H_Lack.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "07_DT_1H_Lack.csv")
