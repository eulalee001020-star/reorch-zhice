"""
GAMSPy — gerado automaticamente de: 06_Double_T_1H.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 06_Double_T_1H.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "06_Double_T_1H.csv")
