"""
GAMSPy — gerado automaticamente de: 07_Double_T_1H.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 07_Double_T_1H.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "07_Double_T_1H.csv")
