"""
GAMSPy — gerado automaticamente de: 25_DT_1H_Lack.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 25_DT_1H_Lack.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "25_DT_1H_Lack.csv")
