"""
GAMSPy — gerado automaticamente de: 24_Double_T_1H.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 24_Double_T_1H.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "24_Double_T_1H.csv")
