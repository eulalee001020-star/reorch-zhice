"""
GAMSPy — gerado automaticamente de: 27_Double_T_1H.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 27_Double_T_1H.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "27_Double_T_1H.csv")
