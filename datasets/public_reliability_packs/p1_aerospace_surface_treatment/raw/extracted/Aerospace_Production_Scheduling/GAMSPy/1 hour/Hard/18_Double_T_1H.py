"""
GAMSPy — gerado automaticamente de: 18_Double_T_1H.gms
...
# ── Opções ────────────────────────────────────────────────────────
m = Container()
options = Options(time_limit=3600, relative_optimality_gap=0.0)
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 18_Double_T_1H.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "18_Double_T_1H.csv")
