"""
GAMSPy — gerado automaticamente de: 28_3H_noLack.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 28_3H_noLack.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "28_3H_noLack.csv")
