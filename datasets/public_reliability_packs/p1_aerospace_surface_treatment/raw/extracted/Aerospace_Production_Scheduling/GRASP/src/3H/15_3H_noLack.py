"""
GAMSPy — gerado automaticamente de: 15_3H_noLack.gms
...
# ── Resolução ─────────────────────────────────────────────────────
print("\n" + "="*60)
print(f"  Resolvendo: 15_3H_noLack.gms")
print("="*60 + "\n")
...
out_path = os.path.join("results", "15_3H_noLack.csv")
